...
$headers = array(
	...
	array("width"=>50,"column"=>"Middle Name"),
...
$data = $con->getData("SELECT employee_id, employee_firstname, employee_middlename, employee_lastname FROM personal_infos$filter");
